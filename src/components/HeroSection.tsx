      ...
      <div className="container-section relative z-10">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="flex flex-col max-w-xl mx-auto md:mx-0 text-center md:text-left">
            <span className="inline-block py-1 px-3 rounded-full text-sm bg-white/10 text-white mb-6 backdrop-blur-sm animate-fade-in">
              The easiest way to analyze GSC data
            </span>
            
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6 animate-fade-in animate-delay-75">
              Effortless GSC Data Sync for Google Sheets
            </h1>
            
            <p className="text-lg text-gray-300 mb-10 animate-fade-in animate-delay-150">
            ...
            <div className="text-sm text-gray-400 animate-fade-in animate-delay-500">
          ...
          <div className="relative animate-fade-in-right animate-delay-300">
            <div className="relative w-full aspect-[4/3] bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl shadow-2xl overflow-hidden border border-gray-700 animate-float">
              ...
              <div className="absolute top-0 left-0 right-0 h-8 bg-gray-800 flex items-center px-3">
                ...
                <div className="absolute inset-x-0 top-0 h-full flex items-center justify-center">
                  <div className="px-4 bg-gray-700 rounded-md text-xs text-gray-300">
              ...
              <div className="pt-8 p-4 h-full flex flex-col">
                ...
                <div className="flex-1 grid grid-cols-6 gap-1">
                  ...
                  {Array.from({ length: 10 }).map((_, rowIndex) => (
                    <React.Fragment key={`row-${rowIndex}`}>
                      <div className="col-span-3 bg-gray-700/70 h-8 rounded"></div>
                      <div className="col-span-1 bg-gray-700/70 h-8 rounded"></div>
                      <div className="col-span-1 bg-gray-700/70 h-8 rounded"></div>
                      <div className="col-span-1 bg-gray-700/70 h-8 rounded"></div>
                    </React.Fragment>
                  ))}
                ...
                <div className="absolute bottom-4 right-4 px-3 py-1.5 bg-white text-black rounded-lg text-xs font-medium shadow-lg flex items-center gap-1">
            ...
            <div className="absolute -top-6 -left-6 w-32 h-32 bg-white/5 rounded-full blur-xl"></div>
          </div>
        </div>
      </div>
    </section>
